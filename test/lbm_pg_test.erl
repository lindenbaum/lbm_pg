...
all_test_() ->
    {foreach, setup(), teardown(),
     [
      ...
      {timeout, ?TIMEOUT, {spawn, fun() -> sync_send_one_group_one_member_few_senders([no_cache]) end}},
      {timeout, ?TIMEOUT, {spawn, fun() -> sync_send_one_group_one_member_few_senders([]) end}},
      {timeout, ?TIMEOUT, {spawn, fun sync_send_one_group_one_member_many_senders/0}},
      {timeout, ?TIMEOUT, {spawn, fun sync_send_one_group_many_members_many_senders/0}},
